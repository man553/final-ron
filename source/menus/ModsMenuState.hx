...
class ModsMenuState extends MusicBeatState
{
	...
	var selector:gameassets.AttachedSprite;
	...
	override function create()
	{
		...
		selector = new gameassets.AttachedSprite();
		selector.xAdd = -205;
		selector.yAdd = -68;
		...
		while (i < modsList.length)
		{
			...
			newMod.icon = new gameassets.AttachedSprite();
			if(loadedIcon != null)
			{
...
class ModMetadata
{
	...
	public var icon:gameassets.AttachedSprite;
