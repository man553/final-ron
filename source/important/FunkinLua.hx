...
class FunkinLua {
	...
	public function new(script:String) {
		...
		set('ratingName', '');
		set('ratingFC', '');
		set('version', menus.MainMenuState.psychEngineVersion.trim());
		...
		Lua_helper.add_callback(lua, "exitSong", function(?skipTransition:Bool = false) {
			...
			misc.CustomFadeTransition.nextCamera = PlayState.instance.camOther;
			if(FlxTransitionableState.skipNextTransIn)
				misc.CustomFadeTransition.nextCamera = null;
		...
		Lua_helper.add_callback(lua, "isNoteChild", function(parentID:Int, childID:Int){
			var parent: gameassets.Note = cast PlayState.instance.getLuaObject('note${parentID}',false);
			var child: gameassets.Note = cast PlayState.instance.getLuaObject('note${childID}',false);
